...
def criterios(valoracion):
    ...
    if valoracion == 'Coche':
        ...
        crt3=ec.Criterio('Frenos [Aceptable][2-3]', Frenos(),'igual', 'puntos', 15, 'Aceptable', False) 
        ...
        crt9=ec.Criterio('Carroceria [Aceptable][3-4]', Carroceria(), 'igual', 'puntos', 5, 'Aceptable', False)
        crt10=ec.Criterio('Carroceria [Correcto][5-6]', Carroceria(), 'igual', 'puntos', 15, 'Correcto', False)
        ...
        crt12=ec.Criterio('Iluminacion [Aceptable][2-3]', Iluminacion(), 'igual', 'puntos', 5, 'Aceptable', False)
        ...
        crt16=ec.Criterio('Suspension [Correcto][2]', Suspension(), 'igual', 'puntos', 15, 'Correcto', False)
        crt17=ec.Criterio('Emisiones [Bajo][0]: impurezas bajos', Emisiones(), 'igual', 'puntos', 10, 'Bajo', False)
        crt18=ec.Criterio('Emisiones [Alto][1]', Emisiones(), 'igual', 'puntos', 5, 'Alto', False)
        ...
        crt23=ec.Criterio('Neumaticos [Aceptable][3]', Neumaticos(), 'igual', 'puntos', 5, 'Aceptable', False)
        crt24=ec.Criterio('Neumaticos [Correcto][4]', Neumaticos(), 'igual', 'puntos', 15, 'Correcto', False)
        ...
        crt1=ec.Criterio('Documentacion [1-3]: permiso, tarjeta inspeccion tecnica, comprobante pago seguro', Documentacion(), 'rango', 'puntos', 15, [1,3], True)
        crt2=ec.Criterio('Frenos [Deteriorado][0]: Frenada', Frenos(),'igual', 'puntos', 0, 'Deteriorado', False)
        crt3=ec.Criterio('Frenos [Aceptable][1]', Frenos(),'igual', 'puntos', 5, 'Aceptable', False) 
        crt4=ec.Criterio('Frenos [Correcto][2]', Frenos(),'igual', 'puntos', 15, 'Correcto', False)    
        crt5=ec.Criterio('Iluminacion [Deteriorado][0-1]: largas, cortas, carretera, antiniebla, intermitentes', Iluminacion(), 'igual', 'puntos', 0, 'Deteriorado', False)
        ...
        crt8=ec.Criterio('Suspension [Deteriorado][0]: muelles, amortiguadores', Suspension(), 'igual', 'puntos', 0, 'Deteriorado', False)
        crt9=ec.Criterio('Suspension [Aceptable][1]', Suspension(), 'igual', 'puntos', 5, 'Aceptable', False)
        crt10=ec.Criterio('Suspension [Correcto][2]', Suspension(), 'igual', 'puntos', 15, 'Correcto', False)
        crt11=ec.Criterio('Emisiones [Bajo][0]: impurezas bajos', Emisiones(), 'igual', 'puntos', 15, 'Bajo', False)
        crt12=ec.Criterio('Emisiones [Alto][1]', Emisiones(), 'igual', 'puntos', 5, 'Alto', False)
        crt13=ec.Criterio('Niveles [Deteriorado][0-1]: frenos, aceite, conductos', Niveles(), 'igual', 'puntos', 0, 'Deteriorado', False)
        crt14=ec.Criterio('Niveles [Aceptable][2]', Niveles(), 'igual', 'puntos', 5, 'Aceptable', False)
        crt15=ec.Criterio('Niveles [Correcto][3]', Niveles(), 'igual', 'puntos', 15, 'Correcto', False)
        crt16=ec.Criterio('Neumaticos [Deteriorado][0]: estado neumaticos, profundidad dibujo (nro neumaticos)', Neumaticos(), 'igual', 'puntos', 0, 'Deteriorado', False)
        crt17=ec.Criterio('Neumaticos [Aceptable][1]', Neumaticos(), 'igual', 'puntos', 5, 'Aceptable', False)
        crt18=ec.Criterio('Neumaticos [Correcto][2]', Neumaticos(), 'igual', 'puntos', 15, 'Correcto', False)
        crt19=ec.Criterio('Motor [Deteriorado][0-1]: ruido, transmision, fuga de aceite', Motor(), 'igual', 'puntos', 0, 'Deteriorado', False)
